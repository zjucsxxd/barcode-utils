...
typedef void (*PageNewConnectionResultFunc) (BMConnection *connection,
                                             gboolean canceled,
                                             GError *error,
                                             gpointer user_data);
...
typedef struct {
	...
	/* Virtual functions */
	gboolean    (*validate)    (CEPage *self, BMConnection *connection, GError **error);
...
typedef CEPage* (*CEPageNewFunc)(BMConnection *connection,
                                 GtkWindow *parent,
...
gboolean ce_page_validate (CEPage *self, BMConnection *connection, GError **error);
...
int ce_get_property_default (BMSetting *setting, const char *property_name);
...
/* Only for subclasses */
BMConnection *ce_page_new_connection (const char *format,
                                      const char *ctype,
