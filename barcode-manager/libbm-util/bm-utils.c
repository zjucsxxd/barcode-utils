 ...
 * a list of BarcodeManager IPv4 addresses (which is a tuple of address, gateway,
 ...
 * GPtrArray of GArrays of guint32s representing a list of BarcodeManager IPv4
 ...
 *
 * Utility function to convert a GPtrArray of GArrays of guint32s representing
 * a list of BarcodeManager IPv4 routes (which is a tuple of route, next hop,
 ...
 * representing a list of BarcodeManager IPv6 addresses (which is a tuple of address,
 ...
 * GPtrArray of GValueArrays representing a list of BarcodeManager IPv6 addresses
 ...
 * (GArray of guchars), and guint32 representing a list of BarcodeManager IPv6
 ...
 * representing a list of BarcodeManager IPv6 routes (which is a tuple of destination,
