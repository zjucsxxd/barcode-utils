...
bm_act_request_init (NMActRequest *req)
{
	...
	// FIXME priv->ac_path = bm_active_connection_get_next_object_path ();
...
dispose (GObject *object)
{
	...
	// FIXME bm_act_request_set_shared (BM_ACT_REQUEST (object), FALSE);
			  ...
			  GValue *value, GParamSpec *pspec)
{
	...
	case PROP_SERVICE_NAME:
		// FIXME bm_active_connection_scope_to_value (priv->connection, value);
		break;
...
bm_act_request_class_init (NMActRequestClass *req_class)
{
	...
	// FIXME add this                                 &dbus_glib_bm_active_connection_object_info);
}
