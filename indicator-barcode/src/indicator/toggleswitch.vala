...
private const double PI_OVER_180 = 0.017453292519943295;
...
public class ToggleSwitch : Gtk.EventBox {
    ...
    /* A switch containing the values ON and OFF (or user-inputed) that
       ...
       This is a direct copy from src/settings to make it easy to add
       toggle switch to the network menu.
    */
   ...
   public ToggleSwitch() {
    ...
    private void draw_background(Cairo.Context cr) {       
        ...
        var left_fill = this.style.base[state];
        var left_stroke = this.style.dark[state];
