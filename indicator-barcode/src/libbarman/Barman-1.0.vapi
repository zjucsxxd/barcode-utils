/* Barman-1.0.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Barman", lower_case_cprefix = "barman_", gir_namespace = "Barman", gir_version = "1.0")]
namespace Barman {
	[CCode (cheader_filename = "Barman-1.0.h")]
	...
	public class Manager : GLib.Object {
		[CCode (has_construct_function = false)]
		public Manager ();
		public async void connect_service (Barman.ServiceType type, Barman.ServiceMode mode, Barman.ServiceSecurity security, uint8 ssid, uint ssid_len, GLib.Cancellable? cancellable) throws GLib.Error;
		...
		public unowned Barman.Service get_default_service ();
		...
		public uint bluetooth_state { get; }
		public uint cellular_state { get; }
		public bool connected { get; }
		public Barman.Service default_service { get; }
		public uint ethernet_state { get; }
		public bool offline_mode { get; set; }
		public uint wifi_state { get; }
	...
	public class Service : GLib.Object {
		...
		public void set_domains_configuration ([CCode (array_length = false)] string[] domains);
		public void set_ipv4_configuration (Barman.IPv4 ipv4);
		public void set_ipv6_configuration (Barman.IPv6 ipv6);
		public void set_nameservers_configuration ([CCode (array_length = false)] string[] nameservers);
	...
	[CCode (cprefix = "BARMAN_IPV4_ERROR_INVALID_", cheader_filename = "Barman-1.0.h")]
	public enum IPv4Error {
		METHOD,
		SETTINGS
	}
	[CCode (cprefix = "BARMAN_IPV4_METHOD_", cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cprefix = "BARMAN_IPV6_ERROR_INVALID_", cheader_filename = "Barman-1.0.h")]
	public enum IPv6Error {
		METHOD,
		SETTINGS
	}
	[CCode (cprefix = "BARMAN_IPV6_METHOD_", cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cprefix = "BARMAN_SERVICE_MODE_", cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cprefix = "BARMAN_SERVICE_SECURITY_", cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cprefix = "BARMAN_SERVICE_STATE_", cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cprefix = "BARMAN_SERVICE_TYPE_", cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cprefix = "BARMAN_TECHNOLOGY_STATE_", cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cprefix = "BARMAN_TECHNOLOGY_TYPE_", cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_APN;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_AUTOCONNECT;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_DEFAULT_TECHNOLOGY;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_DOMAINS;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_DOMAINS_CONFIGURATION;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_ENABLED_TECHNOLOGIES;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_ERROR;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_FAVORITE;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_IMMUTABLE;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_IPV4;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_IPV4_CONFIGURATION;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_IPV6;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_IPV6_CONFIGURATION;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_LOGIN_REQUIRED;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_MCC;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_MNC;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_MODE;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_NAME;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_NAMESERVERS;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_NAMESERVERS_CONFIGURATION;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_OFFLINE_MODE;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_PASSPHRASE;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_PASSPHRASE_REQUIRED;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_ROAMING;
	[CCode (cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string PROPERTY_TECHNOLOGIES;
	[CCode (cheader_filename = "Barman-1.0.h")]
	...
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string TECHNOLOGY_PROPERTY_STATE;
	[CCode (cheader_filename = "Barman-1.0.h")]
	public const string TECHNOLOGY_PROPERTY_TYPE;
	[CCode (cheader_filename = "Barman-1.0.h")]
